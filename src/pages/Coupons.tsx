    ...
    <div className="animate-fade-in">
      ...
      <Card><CardContent className="p-4">
        <div className="relative mb-4">
          ...
          <Input placeholder="Search coupons..." value={search} onChange={e => setSearch(e.target.value)} className="pl-9 max-w-sm" />
        </div>
        {filtered.length === 0 ? (
            ...
            <TableBody>
              {filtered.map(c => (
                <TableRow key={c.id}>
                  ...
                  <TableCell className="text-muted-foreground text-sm">{c.endDate}</TableCell>
