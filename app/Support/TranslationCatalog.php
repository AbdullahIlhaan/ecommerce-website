...
class TranslationCatalog
{
    public static function defaults(): array
    {
        return [
            ...
            ['translation_key' => 'home.highlight_easy_title', 'group_name' => 'home', 'english_text' => 'Easy to use test test test', 'bangla_text' => 'ব্যবহার করা খুবই সহজ', 'notes' => 'Home page highlight card title.', 'is_active' => true],
